   ...
   <?PHP
      ...
      if (isset($_POST['clicked_submit'])) {
          ...
          if (vIsBlank($URL) || !vMaxChars($URL, 100) || !vIsURL($URL)) // not blank, max 400 chars.
              $URLErr = nv();
      	  if (vIsBlank($equipID) || !vMaxChars($equipID, 100) ) // not blank, max 100 chars.
              $EquipErr = nv();
      ...
      <table class='std_form'>
         ...
         <tr>
           ...
           <!-- <td>
             ...
             <td><input type='text' name='txtEquip' class='textBoxStyle1' value='<?= $equipID ?>'/></td>
            <td><span class='errorText'><?= $EquipErr ?></span></td>
         </tr>
         <tr>
            <td colspan="2">
               <hr>
