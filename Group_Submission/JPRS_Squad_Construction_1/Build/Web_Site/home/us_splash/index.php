...
<div id="wrap">
     ...
     <a href="http://www.uniformserver.com"><img src="images/logo.png" align="left" alt="The Uniform Server ZeroXI" /></a>
       <div id="header_txt2" >
         <div style="position:absolute;">
           ...
           Apache 2.4.7 VC10 <br />
           MySQL 5.5.36 <br />
           PHP 5.3, 5.4, 5.5 or 5.6<br />
         </div>
       </div>
  </div>
  ...
  <table>
   ...
   <td>
    <ul>
      <li> Apache 2.4.7 VC10 openssl-1.0.1e</li>
      <li> MySQL 5.5.36-community</li>
      <li> MySQL 5.6.16-community</li>
      <li> Mariadb 5.5.35 </li>
      <li> PHP : 5.3.27-5.3.28</li>
      <li> PHP : 5.4.19-5.4.25</li>
      <li> PHP : 5.5.3-5.5.9</li>
      <li> PHP : 5.6.0</li>
      <li> phpMyAdmin  4.1.7</li>
      <li> phpMyBackupPro 2.3</li>
      <li> Adminer  3.7.1 - 4.0.3</li>
    </ul>
   </td>
   <td>
     &nbsp;&nbsp;&nbsp;&nbsp;
