...
function postQA()
{
    ...
    //Prepare query for database
    //$sql = "INSERT INTO session_question(Question, Session, Accepted, Profile_Id)" . " VALUES (:Question,:Session, 0, :Profile)";
    $sql = "INSERT INTO session_question(Question, Session, Accepted)"
            . " VALUES (:Question,:Session, 0)";
